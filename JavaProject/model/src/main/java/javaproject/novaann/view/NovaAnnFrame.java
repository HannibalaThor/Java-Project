...
import javaproject.novaann.play.IOrderPerformed;
...
public class NovaAnnFrame extends JFrame implements KeyListener, INovaAnnFrame {
	...
	private final IOrderPerformed		novaAnnPlay;
	private final NovaAnnCardView		novaAnnCardView;

	public NovaAnnFrame(final String title, final INovaAnnWorld novaAnnWorld, final IOrderPerformed novaAnnPlay) {
		this.setTitle(title);
		this.setSize(1000, 1000);
		this.setLocationRelativeTo(null);
		this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		this.novaAnnPlay = novaAnnPlay;
	...
	private IOrderPerformed getNovaAnnPlay() {
